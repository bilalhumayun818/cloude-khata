            ...
            return Datatables::of($users)
                ...
                ->addColumn(
                    ...
                    '@can("user.update")
                        ...
                        {{-- 
                        @if(!empty($username))
                        <a href="{{route("sign-in-as-user", $id)}}?save_current=true" class="btn btn-xs btn-success">
                            <i class="fas fa-sign-in-alt"></i> @lang("lang_v1.login_as_username", ["username" => $username])
                        </a>
                        @endif
                        --}}
                    @endcan'
